...
#include "EditorModeTestPluginEditorMode.generated.h"
 ...
 */
UCLASS()
class UEditorModeTestPluginEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_EditorModeTestPluginEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UEditorModeTestPluginEditorMode();
	virtual ~UEditorModeTestPluginEditorMode();
