...
#include "EditorModeTestPluginInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UEditorModeTestPluginInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UEditorModeTestPluginInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UEditorModeTestPluginInteractiveTool* NewTool = NewObject<UEditorModeTestPluginInteractiveTool>(SceneState.ToolManager);
...
UEditorModeTestPluginInteractiveToolProperties::UEditorModeTestPluginInteractiveToolProperties()
{
...
void UEditorModeTestPluginInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UEditorModeTestPluginInteractiveTool::Setup()
{
	...
	Properties = NewObject<UEditorModeTestPluginInteractiveToolProperties>(this, "Measurement");
...
void UEditorModeTestPluginInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UEditorModeTestPluginInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UEditorModeTestPluginInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UEditorModeTestPluginInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UEditorModeTestPluginInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UEditorModeTestPluginInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UEditorModeTestPluginInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UEditorModeTestPluginInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UEditorModeTestPluginInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
