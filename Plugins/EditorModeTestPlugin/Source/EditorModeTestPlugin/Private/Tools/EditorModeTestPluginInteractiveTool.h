...
#include "EditorModeTestPluginInteractiveTool.generated.h"


/**
 * Builder for UEditorModeTestPluginInteractiveTool
 */
UCLASS()
class EDITORMODETESTPLUGIN_API UEditorModeTestPluginInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UEditorModeTestPluginInteractiveTool
 */
UCLASS(Transient)
class EDITORMODETESTPLUGIN_API UEditorModeTestPluginInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UEditorModeTestPluginInteractiveToolProperties();
...
/**
 * UEditorModeTestPluginInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class EDITORMODETESTPLUGIN_API UEditorModeTestPluginInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UEditorModeTestPluginInteractiveToolProperties> Properties;
